...
def model_chooser(algorithm):
    ...
    if algorithm == "Logistic Regression":
        ...
        model = create_model("logistic_regression", C=C, penalty=penalty, solver="saga", max_iter=max_iter)
    ...
    # ___________ Random Forest ___________
        ...
        model = create_model("random_forest", n_estimators=n_estimators, max_depth=max_depth, min_samples_split=min_samples_split, min_samples_leaf=min_samples_leaf, bootstrap=bootstrap)
    ...
    # ___________ KNN ___________
        ...
        model = create_model("knn", n_neighbors=n_neighbors, weights=weights, metric=metric)
    ...
    # ___________ Decision Tree ___________
        ...
        min_samples_split = st.sidebar.slider("Min samples split", 1, 10)
        min_samples_leaf = st.sidebar.slider("Min samples leaf", 1, 10)
        model = create_model("decision_tree", max_depth=max_depth, min_samples_split=min_samples_split, min_samples_leaf=min_samples_leaf)
    ...
    # ___________ Random Forest Regression ___________
        ...
        bootstrap = st.sidebar.selectbox("Bootstrap", ["True", "False"])
        bootstrap = 1 if bootstrap == "True" else 0
        model = create_model("random_forest_regression", n_estimators=n_estimators, max_depth=max_depth, min_samples_split=min_samples_split, min_samples_leaf=min_samples_leaf, bootstrap=bootstrap)
    ...
    # ___________ KNN Regression ___________
        ...
        weights = st.sidebar.selectbox("Weights", ["uniform", "distance"])
        metric = st.sidebar.selectbox("Metric", ["euclidean", "manhattan", "minkowski"])
        model = create_model("knn_regression", n_neighbors=n_neighbors, weights=weights, metric=metric)
    ...
    # ___________ Decision Tree Regression ___________
        ...
        min_samples_split = st.sidebar.slider("Min samples split", 1, 10)
        min_samples_leaf = st.sidebar.slider("Min samples leaf", 1, 10)
        model = create_model("decision_tree_regression", max_depth=max_depth, min_samples_split=min_samples_split, min_samples_leaf=min_samples_leaf)
    ...
    # ___________ KMeans ___________
        ...
        model = create_model("kmeans", n_clusters=n_clusters, init=init, max_iter=max_iter)
    ...
    # ___________ Agglomerative Clustering ___________
        ...
        model = create_model("agglomerative_clustering", n_clusters=n_clusters, linkage=linkage)
